	...
	$().ready(function(){
		...
		$("#dailyWriteBtn").click(function(){
			...
			if(mode == "modify"){
				...
				var url = "<c:url value="/daily/dairy/${(year*10000)+(month*100)+date}"/>"
			}
		...
		<div>
			...
			--><div id="center-page">
				<form:form modelAttribute="dailyWriteForm">
					...
					내용 <textarea rows="10" cols="10" id="scheduleBody" name="scheduleBody"></textarea>
					<input type="button" id="dailyWriteBtn" value="추가하기">
